...
@section('content')
        ...
        {{-- image/GIF --}}
        <img src="gif/aboutus.mp4" style="width: 100%; height: auto;" />
        <section class="py-5">
            <div class="container px-5">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-6 mb-5">
                        <div class="card h-100 shadow border-0">
                            <div class="card-body p-4">
                                <div class="badge bg-primary bg-gradient rounded-pill mb-4 fs-6 px-3 py-2">Vision</div>
                    ...
                    <div class="col-lg-6 mb-5">
                        <div class="card h-100 shadow border-0">
                            <div class="card-body p-4">
                                <div class="badge bg-primary bg-gradient rounded-pill mb-4 fs-6 px-3 py-2">Mission</div>
                ...
                <div class="row gx-5">
                        ...
                        <div class="card h-100 shadow border-0">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-4 fs-6 px-3 py-2">Quality Education</div>
                                    <img class="card-img-top mb-4" src="images/aboutus/sdg4.png" alt="..." />
                                </div>                            
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-4 fs-6 px-3 py-2">Reduced Inequalities</div>
                                    <img class="card-img-top mb-4" src="images/aboutus/sdg10.png" alt="..." />
                                </div>  
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-4 fs-6 px-3 py-2">Partnerships for the Goals</div>
                                    <img class="card-img-top mb-4" src="images/aboutus/sdg17.png" alt="..." />
                                </div>  
